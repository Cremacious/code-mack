...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    description: 'A fully responsive admin dashboard with live Recharts data visualisations, KPI cards, user and product management tables, order tracking, a multi-tab settings panel, and a sales analytics page.',
  ...
  },
  {
    ...
    description: 'A multi-page restaurant website for a Gulf Coast seafood concept. Includes a tabbed seasonal menu, reservation form, masonry photo gallery, team and story pages, and a mobile-first responsive layout throughout.',
  ...
  },
  {
    ...
    description: 'An editorial fine art photography portfolio with a full-bleed hero, CSS masonry gallery with lightbox, series showcase, about page with bio and stats, and a minimal contact form.',
    tech: ['Next.js', 'TypeScript', 'Tailwind CSS', 'Next/Image'],
    liveUrl: 'https://art-portfolio-wheat.vercel.app',
    githubUrl: null,
    status: 'Demo',
    statusColor: 'text-amber-300 bg-amber-400/15',
    gradient: 'from-amber-500/15 to-orange-500/10',
    imagePath: '/images/portfolio/maren-cole.png',
  },
];
